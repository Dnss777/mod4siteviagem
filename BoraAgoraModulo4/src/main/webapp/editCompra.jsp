...
<!-- 	            </div> -->
                   <div class="form-group mb-3">
	                ...
	                <input type="hidden" id="id" name="id" class="form-control" value="${compra.id_Compra}" />
	            </div>
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="text" id="data" name="data_Compra" class="form-control" value="${compra.data_Compra}" />
	            </div>
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="total" id="total" name="total_Compra" class="form-control" value="${compra.total_Compra}" />
	            </div>
