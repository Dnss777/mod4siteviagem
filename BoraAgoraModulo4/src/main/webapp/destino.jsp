 ...
 <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>${d.valor_Destino}</td>

                        <td>
                            <a href="destinos-edit?id=${d.id_Destino}" class="btn btn-primary mb-1" >Editar</a>

                            <a href="destinos-delete?id=${d.id_Destino}" onclick="return confirm('Deseja excluir ${d.nome_Destino}?')" class="btn btn-danger mb-1">Excluir</a>
                        </td>
