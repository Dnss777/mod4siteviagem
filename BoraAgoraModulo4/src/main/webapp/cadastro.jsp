 ...
 <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="cliente-edit?id=${c.id}" class="btn btn-primary mb-1" >Editar</a>

                            <a href="cliente-delete?id=${c.id}" onclick="return confirm('Deseja excluir ${c.nome_Completo}?')" class="btn btn-danger mb-1">Excluir</a>
                        </td>
