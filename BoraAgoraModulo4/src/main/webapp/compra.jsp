...
<nav class="navbar">
 ...
 <table class="table">
                  ...
                  <tbody>
                     <jstl:forEach items="${compra}" var="cm"> 


                    <tr>
                        <td>${cm.id_Compra}</td>
                        <td>${cm.data_Compra}</td>
                        <td>${cm.destinos.nome_Destino}</td>
                        <td>${cm.cliente.nome_Completo}</td>
                        <td>${cm.total_Compra}</td>

                        <td>
                            <a href="compra-edit?id=${cm.id_Compra}" class="btn btn-primary mb-1" >Editar</a>

                            <a href="compra-delete?id=${cm.id_Compra}" onclick="return confirm('Deseja excluir ${cm.id_Compra}?')" class="btn btn-danger mb-1">Excluir</a>
                        </td>
